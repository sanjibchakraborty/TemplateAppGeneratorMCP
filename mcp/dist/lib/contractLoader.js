...
import { ensureGeneratorRoot, getDocsPath, } from "./generatorRoot.js";
/**
 ...
 */
export async function loadContract(relativePath) {
 ...
 */
export async function loadContracts(relativePaths) {
    const missing = [];
    const results = [];
 ...
 */
export async function verifyRepoStructure() {
    try {
